...
const TermsCondition = () => {
  ...
  const getPrivacyPolicy = async () => {
    const apiData = await get("privacy_policy/getTerms"); // Specify the endpoint you want to call
...
<h4 style={{ fontSize: '36px', fontWeight: '500', padding: '10px' }}> Terms and Conditions</h4>
</Col>
          ...
          <Col className="d-flex align-items-right justify-content-right"
            ...
            <Button.Ripple
              ...
              onClick={async () => {
                ...
                const apiData = await post("privacy_policy/create_update_terms", postData); // Specify the endpoint you want to call
                console.log("apixxsData")
